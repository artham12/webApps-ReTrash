        ...
        <div className=" bg-white">
            <div className=" mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className=" mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                            ...
                            <div className=" flex h-full flex-col items-center justify-center space-y-1">
                                <div
                                    ...
                                    <Image
                                        ...
                                        fill
                                        loading="eager"
                                        alt=" empty shoppingg cart retrash"
                                    />
                                </div>
                                <div>
                                    ...
                                    <p className=" text-muted-foreground text-center">
                                        Whoops! Nothing to show here yer.
                                    </p>
                                </div>
                            </div>
                        ) : null}
                        ...
                        <ul className={cn({
                            ...
                            {isMounted && items.map(({ product }) => {
                                const label = PRODUCT_CATEGORIES
                                    .find((c) => c.value === product.category)?.label
                    ...
                    <section className=" mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-0">
